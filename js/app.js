...
const CATEGORIES = {
  ...
  meal: {
    ...
    name: '식사',
    slots: [
      { label: '메뉴', items: ['떡볶이','돈까스','초밥','마라탕','파스타','피자','라멘','삼겹살','치킨','한식 백반','쌀국수','커리','햄버거','곱창/막창','감자탕','부대찌개','냉면','칼국수','짜장면/짬뽕','샤브샤브','보쌈/족발','해산물','스테이크','타코/멕시칸'] },
    ],
  },
  dessert: {
    id: 'dessert',
    ...
    name: '후식',
    slots: [
      { label: '디저트', items: ['쿠키','케이크','아이스크림','빙수','타르트','마카롱','와플','크레페','도넛','버블티','소프트아이스크림','치즈케이크','롤케이크','크로플','젤라또','파르페','푸딩','브라우니','달고나','약과'] },
    ],
  },
  activity: {
    id: 'activity',
    ...
    name: '놀거리',
    slots: [
      { label: '활동', items: ['가챠 뽑기','영화','한강 피크닉','보드게임 카페','방탈출','노래방','전시회/미술관','쇼핑','카페 투어','동물원/아쿠아리움','팝업스토어','플리마켓','야경 드라이브','사진관/포토부스','공방 체험','독립서점','만화카페','타로카페','공원 산책'] },
    ],
  },
};
